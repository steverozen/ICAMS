context("CatSNS192StrandToPdf")

test_that("CatSNS192StrandToPdf function is working properly", {
  ...
  out <- CatSNS192StrandToPdf(cat, "PlotCatSNS192Strand.test.pdf", type = rep(type, 2))
