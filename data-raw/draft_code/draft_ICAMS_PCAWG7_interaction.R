...
#' Return the PCAWG sample identifiers corresponding to \code{aliquot.id}.
#' 
#' @param aliquot.id Character vector of PCAWG aliquot identifiers. e.g. 
#' 1e2dcbcc-771c-43c5-8c8d-e0eb77cb3494.
#' 
#' @return Character vecotor the the corresponding PCAWG sample identifiers, e.g. "SP117655
#' 
#' @export
...
#' Return the PCAWG sample identifier corresponding to \code{aliquot.id}
#' 
#' @param sample.id Character vector of PCAWG sample identifiers, e.g. "SP117655
#' 
#' @return Character vector of the corresponding PCAWG aliquot identifiers, e.g. 
#' 1e2dcbcc-771c-43c5-8c8d-e0eb77cb3494.
#' 
#' @export
