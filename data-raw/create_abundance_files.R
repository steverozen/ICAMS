...
abundance.2bp.genome.GRCm38 <-
  CreateDinucAbundance("data-raw/nucleotide_abundance/mm10_masked_4bp.txt")
abundance.3bp.genome.GRCm38 <-
  CreateTrinucAbundance("data-raw/nucleotide_abundance/mm10_masked_3bp.txt")
abundance.4bp.genome.GRCm38 <-
  CreateTetranucAbundance("data-raw/nucleotide_abundance/mm10_masked_4bp.txt")
abundance.5bp.genome.GRCm38 <-
  CreatePentanucAbundance("data-raw/nucleotide_abundance/mm10_masked_5bp.txt")

abundance.2bp.exome.GRCm38 <-
  CreateDinucAbundance("data-raw/nucleotide_abundance/mm10_masked_AgilentV1_4bp.txt")
abundance.3bp.exome.GRCm38 <-
  CreateTrinucAbundance("data-raw/nucleotide_abundance/mm10_masked_AgilentV1_3bp.txt")
abundance.4bp.exome.GRCm38 <-
  CreateTetranucAbundance("data-raw/nucleotide_abundance/mm10_masked_AgilentV1_4bp.txt")
abundance.5bp.exome.GRCm38 <-
  CreatePentanucAbundance("data-raw/nucleotide_abundance/mm10_masked_AgilentV1_5bp.txt")
