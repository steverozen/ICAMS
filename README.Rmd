...
[![R-CMD-check](https://github.com/steverozen/ICAMS/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/steverozen/ICAMS/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
> Rozen SG, Jiang NH, Boot A, Liu M, Wu Y, Huang MN, Chang JG (2025). ICAMS:In-depth Characterization and Analysis of Mutational Signatures. R package version 3.0.9, https://CRAN.R-project.org/package=ICAMS.
