...
Alternatively, you can download the [package source](https://raw.githubusercontent.com/steverozen/ICAMS/master/data-raw/source-file/ICAMS_2.2.6.tar.gz) of recent *stable development* version of ICAMS to your computer, then do:
