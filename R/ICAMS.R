...
#' and signatures for single nucleotide
...
#'
#' @section Catalogs and signatures:
...
#' on either:
#' \enumerate{
#'   \item mutation counts (a "count-based mutational signature"), or
#'
...
#'  Genomes other than the two human genomes mentioned above are
