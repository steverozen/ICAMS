...
#' signatures.
#'
#' "ICAMS" can read in VCFs generated by Strelka, Mutect or other variant
#' callers, and collate the mutations  into "catalogs" of mutational spectra.
#' "ICAMS" can create and plot catalogs of mutational spectra or signatures for
...
#' mutation densities (see below), or of mutational signatures.
#'
...
#' * \code{\link{PlotCatalog}} function plots mutational spectra
...
#'
#' @section Wrapper function to create catalogs from VCFs and plot the catalogs to PDF files:
#' * \code{\link{VCFsToCatalogsAndPlotToPdf}} creates all types of SBS, DBS
#' and ID catalogs from VCFs and plots the catalogs.
#'
#'
#' @section Wrapper function to create a zip file which contains catalogs and plot PDFs from VCF files:
#' * \code{\link{VCFsToZipFile}} creates a zip file which contains SBS, DBS
...
#' * \code{\link{WriteCatalog}} function
#' writes a catalog to a file.
#'
#' @section Reading catalogs:
#' * \code{\link{ReadCatalog}} function
...
#' \code{\link{CollapseCatalog}} function
#' \enumerate{
#' \item Takes a mutational spectrum or signature catalog
...
#'
#' \item Collapses it to a catalog based on a coarser-grained set of features
...
#'
#'\item \code{\link{all.abundance}} The counts of different source sequences
#'for mutations.
#'
...
#'  }
#'#'
#' @useDynLib ICAMS, .registration = TRUE
